...
from ..core.executor import DirectExecutor
...
class MantisServiceServicer(mantis_core_pb2_grpc.MantisServiceServicer):
    ...
    async def ProcessSimulationInput(self, 
                                   request: mantis_core_pb2.SimulationInput, 
                                   context: grpc.ServicerContext) -> mantis_core_pb2.SimulationOutput:
        """
        ...
        try:
            ...
            logger.info(f"Execution strategy: {mantis_core_pb2.ExecutionStrategy.Name(request.execution_strategy) if request.execution_strategy else 'DEFAULT'}")
            ...
            logger.info(f"Executing simulation with orchestrator")
            ...
            error_output.final_state = mantis_core_pb2.TASK_STATE_FAILED if hasattr(mantis_core_pb2, 'TASK_STATE_FAILED') else 0
            return error_output
    
    async def ProcessUserRequest(self,
    ...
    async def ProcessTeamRequest(self,
                               request: mantis_core_pb2.TeamExecutionRequest,
                               context: grpc.ServicerContext) -> mantis_core_pb2.TeamExecutionResult:
        """
    ...
    async def ProcessNarratorRequest(self,
                                   request: mantis_core_pb2.NarratorRequest,
                                   context: grpc.ServicerContext) -> mantis_core_pb2.AgentResponse:
        """
