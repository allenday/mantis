...
class MantisJSONRPCService:
    ...
    async def handle_request(self, request: web_request.Request) -> web.Response:
        ...
        try:
            ...
            return web.json_response(
                JSONRPCError.create_error_response(None, JSONRPCError.INTERNAL_ERROR, str(e)),
                status=500
            )
    ...
    def _simulation_output_to_dict(self, output: mantis_core_pb2.SimulationOutput) -> Dict[str, Any]:
        ...
        if output.results:
            result["nested_results"] = [
                self._simulation_output_to_dict(nested_result)
                for nested_result in output.results
            ]
    ...
    async def handle_health(self, request: web_request.Request) -> web.Response:
        ...
        health.update({
            ...
            "orchestrator_initialized": health["orchestrator"]
        })
