...
async def get_random_agents_from_registry(count: int = 3) -> List[mantis_core_pb2.AgentInterface]:
    """
    ...
    Returns:
        List of AgentInterface protobuf objects representing selected agents
    ...
    try:
        ...
        logger.info("Retrieved agents from registry", 
        ...
        logger.error("Team formation failed - registry unavailable", 
    ...
    if len(all_agents) < count:
        ...
        logger.warning("Insufficient agents in registry", 
                      structured_data={"requested": count, "available": available_count})
    ...
    log_tool_result("team_formation", "get_random_agents_from_registry", 
