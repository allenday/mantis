...
class BaseTool(ABC):
    ...
    def log_tool_invocation(self, method_name: str, params: Optional[Dict[str, Any]] = None) -> None:
        ...
        self.logger.info(
            f"🎯 TOOL_INVOKED: {method_name} by {agent_ctx.get('agent_name', 'unknown')}", structured_data=log_data
        )
    ...
    def log_tool_result(self, method_name: str, result_info: Optional[Dict[str, Any]] = None) -> None:
        ...
        self.logger.info(
            f"✅ TOOL_COMPLETED: {method_name} by {agent_ctx.get('agent_name', 'unknown')}", structured_data=log_data
        )
...
def log_tool_invocation(tool_name: str, method_name: str, params: Optional[Dict[str, Any]] = None) -> None:
    ...
    logger.info(f"🎯 TOOL_INVOKED: {method_name} by {agent_ctx.get('agent_name', 'unknown')}", structured_data=log_data)
