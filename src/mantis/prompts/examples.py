...
from .variables import CompositionVariables
from ..proto.mantis.v1.mantis_persona_pb2 import (
    MantisAgentCard, PersonaCharacteristics, CompetencyScores, DomainExpertise, 
    RoleAdaptation, RolePreference
)
...
def create_example_strategic_leader() -> MantisAgentCard:
    ...
    base_card.description = "Experienced strategic leader with expertise in organizational transformation and long-term planning"
    ...
    characteristics.communication_style = "Direct but collaborative, emphasizing clarity and inspiring confidence in the vision"
    ...
    characteristics.characteristic_phrases.extend([
        "Let's think about the second and third-order effects",
    ...
    expertise.primary_domains.extend([
        "Strategic Planning", 
        "Organizational Transformation",
        "Leadership Development"
    ])
    expertise.secondary_domains.extend([
        "Change Management",
        "Business Strategy"
    ])
    expertise.methodologies.extend([
        "Systems Thinking",
        "Design Thinking", 
...
def create_example_technical_specialist() -> MantisAgentCard:
    ...
    characteristics.thinking_patterns.extend([
        "Analytical decomposition of complex problems",
        "Hypothesis-driven experimentation"
    ])
    characteristics.characteristic_phrases.extend([
        "What does the data actually tell us?",
        "Let's validate that assumption with a proper test"
    ])
